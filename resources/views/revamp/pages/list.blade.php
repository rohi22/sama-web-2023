                ...
                <div class="col-lg-12 d-flex justify-content-between">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                         @forelse($childcategories as $cc)
                              ...
                              <button class="nav-link " id="id{{$cc->id}}" data-bs-toggle="pill" data-bs-target="#{{$cc->id}}" type="button" role="tab" aria-controls="{{$cc->id}}" aria-selected="true" onclick="getThirdLevelThemeC({{$cc->id}},'{{$cc->cat_title}}')">{{$cc->cat_title}}</button>
                            </li>
                         @empty
                         @endforelse
                    </ul>
