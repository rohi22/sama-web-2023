            ...
            <div class="row text-center text-lg-start">
                <div class="col-lg-12">
                    ...
                    <p>At Sama Engineering, accessible from https://samaengineering.com, one of our main priorities is
                        ...
                        collected and recorded by Sama Engineering and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Sama Engineering.
                        This policy is not applicable to any information collected offline or via channels other than
                        this website. </p>
                    <h3 class="mt-5 mb-4">Consent</h3>
                    <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
                    <h3 class="mt-5 mb-4">Information we collect</h3>
                    ...
                    <h3 class="mt-5 mb-4">Cookies and Web Beacons</h3>
                    <p>Like any other website, Sama Engineering uses 'cookies'. These cookies are used to store
                    ...
                    <h3 class="mt-5 mb-4">Advertising Partners Privacy Policies</h3>
                    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Sama
                        Engineering.</p>
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Sama Engineering,
                    ...
                    <p>Note that Sama Engineering has no access to or control over these cookies that are used by
                        third-party advertisers.</p>
                    <h3 class="mt-5 mb-4">Third Party Privacy Policies</h3>
                    <p>Sama Engineering's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <h3 class="mt-5 mb-4">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
                    ...
                    <h3 class="mt-5 mb-4">GDPR Data Protection Rights</h2>
                    ...
                    <ul class="fa-ul mx-0 mt-4">
                        <li class="mb-4"><span class="fa-li"><i class="fa fa-circle"></i></span> <b>The right to access</b> – You have the right to request copies of your personal data. We may charge
                            you a small fee for this service.</li>
                        <li class="mb-4"><span class="fa-li"><i class="fa fa-circle"></i></span> <b>The right to rectification</b> – You have the right to request that we correct any information you
                            believe is inaccurate. You also have the right to request that we complete the information you
                            believe is incomplete.</li>
                        <li class="mb-4"><span class="fa-li"><i class="fa fa-circle"></i></span> <b>The right to erasure</b> – You have the right to request that we erase your personal data, under
                            certain conditions.</li>
                        <li class="mb-4"><span class="fa-li"><i class="fa fa-circle"></i></span> <b>The right to restrict processing</b> – You have the right to request that we restrict the processing
                    ...
                    <p> If you make a request, we have one month to respond to you. If you would like to exercise any of
                        these rights, please contact us.</p>
                    <h3 class="mt-5 mb-4">Children's Information</h3>
                    <p>Another part of our priority is adding protection for children while using the internet. We
                        encourage parents and guardians to observe, participate in, and/or monitor and guide their
                        online activity.</p>
                    <p>Sama Engineering does not knowingly collect any Personal Identifiable Information from children
