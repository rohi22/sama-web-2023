 ...
 <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                    <form action="{{asset('category/new')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group @if($errors->has('cat_slug')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger"  name="cat_slug" value="{{ old('cat_slug') }}">
                                    ...
                                    <div class="form-group @if($errors->has('cat_meta_title')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="cat_meta_title" value="{{ old('cat_meta_title') }}">
                                    ...
                                    <div class="form-group @if($errors->has('cat_desc')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger"   name="cat_desc" value="{{ old('cat_desc') }}">
                                    ...
                                    <div class="form-group @if($errors->has('cat_og_tags')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" name="cat_og_tags" id="og_tags">
                                    ...
                                    <div class="form-group @if($errors->has('cat_twitter_tags')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" name="cat_twitter_tags" id="twitter_tags">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3"></label>
                                        <div class="col-md-9">
                                             <img src="" style="width:100px;height:60px;" id="icon_show">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3"></label>
                                        <div class="col-md-9">
                                             <img src="" style="width:100px;height:60px;" id="cat_og_img_show">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label class="control-label text-right col-md-3"></label>
