        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 devider position-relative py-8">
                    <h4>HEAD OFFICE - <span class="text-TColor">PAKISTAN</span></h4>
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <p class="mb-0">talk@samaengineering.com</p>
                    </div>

                    <h4 class="mt-5">INTERNATIONAL OFFICE - <span class="text-TColor">USA</span></h4>
                    <div class="d-flex mt-4">
                        <i class="fa fa-map-marker-alt text-TColor me-3"></i>
                        <p class="mb-0">Nazimabad # 2, Block-A, Plot No. 1/32, Opposite Firdous <br>
                            Colony KHI-74600, Pakistan</p>
                    ...
                    <h4 class="mt-5">LAHORE  OFFICE - <span class="text-TColor">PAKISTAN</span></h4>
                    <div class="d-flex mt-4">
                        <i class="fa fa-map-marker-alt text-TColor me-3"></i>
                        <p class="mb-0">Nazimabad # 2, Block-A, Plot No. 1/32, Opposite Firdous <br>
                            Colony KHI-74600, Pakistan</p>
