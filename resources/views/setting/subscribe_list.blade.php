 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">All Subscriptions</h4>
        </div>
                      ...
                      @if(session()->has('message'))<div class="alert alert-success col-md-5" style="text-align: center;left:24%;">{{ session()->get('message') }}</div>@endif
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{$i->email}}</td>
                                <td>                                    
                                 @if(session('role') == 'admin')<a onclick="remove({{$i->id}})" data-toggle="tooltip" title="Delete" style="cursor: pointer;"><i class="far fa-trash-alt" style="color:red;padding:5px;"></i></a>
                                 @endif
                                </td>
                            </tr>
                            @endforeach
...
@section('page-scripts')
    ...
    $(document).ready(function() {
        ...
        function remove(id){
            ...
            if (r === true) {
                window.location="<?php echo url('subscribe/delete/'); ?>/"+id;
            }
        }
    </script>    
@endsection
