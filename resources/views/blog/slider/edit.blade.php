 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Blog Slider</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Edit Blog Slider</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                   <form action="{{url('/blog/slider/edit/'.$data->id)}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8"> 
                                    <div class="form-group @if($errors->has('s_image1')) has-danger @endif row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                             <img src="{{asset('uploads/blog/slider/'.$data->s_image1)}}" style="width:100px;height:60px;" id="img1_show">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group @if($errors->has('s_image2')) has-danger @endif row">
                                     ...
                                     <div class="form-group row">
                                        <label class="control-label text-right col-md-3"></label>
                                        <div class="col-md-9">
                                             <img src="{{asset('uploads/blog/slider/'.$data->s_image2)}}" style="width:100px;height:60px;" id="img2_show">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group @if($errors->has('s_image3')) has-danger @endif row">
                                     ...
                                     <div class="form-group row">
                                        <label class="control-label text-right col-md-3"></label>
                                        <div class="col-md-9">
                                             <img src="{{asset('uploads/blog/slider/'.$data->s_image3)}}" style="width:100px;height:60px;" id="img3_show">
                                        </div>
                                    </div>
