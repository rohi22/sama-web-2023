 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Blog Category</h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                     <form action="{{url('/blog/category/edit/'.$data->id)}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group @if($errors->has('cat_desc')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-danger" id="cat_desc"  name="cat_desc" value="{{ $data->cat_desc }}">{{ $data->cat_desc }}</textarea>
                                    ...
                                    <div class="form-group @if($errors->has('cat_meta_keyword')) has-danger @endif row">
                                     ...
                                     <div class="form-group @if($errors->has('cat_meta_tags')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" name="cat_meta_tags" id="meta_tags" value="{{$meta_tags}}">
