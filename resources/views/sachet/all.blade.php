 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">All Sachets</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">All Sachets</li>
                </ol>
                <a href="{{url('sachet/new')}}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</button></a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="card-body">
                    <div class="table-responsive m-t-40">
                      ...
                      <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody><?php $no=0 ?>
                                @foreach($sachets as $i)<?php $no++ ?>
                                <tr>
                                    <td>{{$no}}</td>
                                    <td><img style="width: 60px;height: 50px;border-radius: 7px;"src="{{asset('/uploads/sachet/'.$i->sachet_image)}}"></td>
                                    <td>{{$i->sachet_title}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
